...
import com.example.firebase.Activity.AddNoteActivity;
...
public class MyNotesFragment extends Fragment {
  ...
  private OnFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button addNoteBtn=(Button)myNotesView.findViewById(R.id.add_notes_btn);
        ListView myNoteListLv=(ListView)myNotesView.findViewById(R.id.myNotesList);
        addNoteBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent addNotesIntent=new Intent(getContext(), AddNoteActivity.class);
        ...
        myNoteListLv.setAdapter(arrayAdapter);
